# -*- coding: utf-8 -*-
"""Choose_Model_Using_Sample30_Part2

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1swrsSQlUYTUJiBwS5Pkep81D5TsxQ9py
...
random_out = random.sample(idx_list, 30)[14:]
random_out
...
for k in tqdm(random_out):
  ...
  with open("/content/drive/MyDrive/snapshot/compare_score/score_log.txt", 'w') as f:
    f.write(f"{k},{model_name}\n")
  f.close()

  with open(f"/content/drive/MyDrive/snapshot/compare_score/model_dict_{k}.pkl", 'wb') as f:
