# -*- coding: utf-8 -*-
"""Performance_DTW_PER_Arima_Using_Top10

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1deYFheB1ZrpkGcWyX09t7iRoDKOjuY5q
"""
...
#한 종목 당 5분 소요: 5*192/60 = 16시간 예상
#2시간 24개씩 8번에 나눠서 계산

#1) 0~23 => 117/240 = 48.75%
#2시간 33분 소요

cnt = 0
for idx in range(0,742*24+1,742):
...
cnt = 0
for idx in range(742*24+1,742*48+1,742):
  data1 = res2[idx:idx+742]["PER"]
  per_df = dtw_per_df(data1)
  per_ari_result = arima_df(per_df, Close_300[:(train_idx+1)], 1000000) # 6분 소요
  per_ari_compare = compare(per_ari_result, answer_300, 1000000)
...
cnt = 0
for idx in range(742*48+1,742*72+1,742):
  data1 = res2[idx:idx+742]["PER"]
  per_df = dtw_per_df(data1)
  per_ari_result = arima_df(per_df, Close_300[:(train_idx+1)], 1000000) # 6분 소요
  per_ari_compare = compare(per_ari_result, answer_300, 1000000)
...
cnt = 0
for idx in range(742*72+1,742*96+1,742):
  data1 = res2[idx:idx+742]["PER"]
  per_df = dtw_per_df(data1)
  per_ari_result = arima_df(per_df, Close_300[:(train_idx+1)], 1000000) # 6분 소요
  per_ari_compare = compare(per_ari_result, answer_300, 1000000)
...
cnt = 0
for idx in range(742*96+1,742*120+1,742):
  data1 = res2[idx:idx+742]["PER"]
  per_df = dtw_per_df(data1)
  per_ari_result = arima_df(per_df, Close_300[:(train_idx+1)], 1000000) # 6분 소요
  per_ari_compare = compare(per_ari_result, answer_300, 1000000)
...
cnt = 0
for idx in range(742*120+1,742*144+1,742):
  data1 = res2[idx:idx+742]["PER"]
  per_df = dtw_per_df(data1)
  per_ari_result = arima_df(per_df, Close_300[:(train_idx+1)], 1000000) # 6분 소요
  per_ari_compare = compare(per_ari_result, answer_300, 1000000)
...
cnt = 0
for idx in range(742*144+1,742*168+1,742):
  data1 = res2[idx:idx+742]["PER"]
  per_df = dtw_per_df(data1)
  per_ari_result = arima_df(per_df, Close_300[:(train_idx+1)], 1000000) # 6분 소요
  per_ari_compare = compare(per_ari_result, answer_300, 1000000)
...
cnt = 0
for idx in range(742*168+1,742*192,742):
  data1 = res2[idx:idx+742]["PER"]
  per_df = dtw_per_df(data1)
  per_ari_result = arima_df(per_df, Close_300[:(train_idx+1)], 1000000) # 6분 소요
  per_ari_compare = compare(per_ari_result, answer_300, 1000000)
